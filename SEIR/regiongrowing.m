function J=regiongrowing(I,reg_maxdist,x,y) %Argument order changed by Joelle
...
while(pixdist<reg_maxdist&&reg_size<numel(I))
    ...
    for j=1:4,
        ...
        % Check if neighbour is inside or outside the image % And check
        % that intensity non zero (Joelle)
        ins=(xn>=1)&&(yn>=1)&&(xn<=Isizes(1))&&(yn<=Isizes(2))&&I(xn,yn)>0;
