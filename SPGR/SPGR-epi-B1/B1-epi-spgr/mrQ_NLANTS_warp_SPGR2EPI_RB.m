...
%unix sell path (./bachrc). The registration happens in two steps: First,
...
%% I. We first need to make matlab work with the bachrc
...
%% III. Name and save SPGR T1 map in EPI space
