function [s,xform xf bb] = relaxAlignAll_xf(s, refImg, outMm, bb, interp)
%
...
% xf is the transform we need it for the multi chanels data
%
% HISTORY:
...
% 2011.08.18 add an output xfpwd
