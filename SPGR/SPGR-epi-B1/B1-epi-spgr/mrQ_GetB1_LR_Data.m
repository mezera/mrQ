...
% Load data from the M0 and T1 file for a local regression defined by voxel index and opt
%
...
if any(Bzide)==0, Bzide(find(Bzide==0))=1;end % no zero box size
...
BM1=logical(BM(XX(1):XX(2),YY(1):YY(2),ZZ(1):ZZ(2)));
   ...
   %% If T1 values are wrong, we will skip the voxels
