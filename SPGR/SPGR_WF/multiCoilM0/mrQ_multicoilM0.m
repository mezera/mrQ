function [combineFile,MultiCoilFile] = mrQ_multicoilM0(datDir,T1file,B1file,niifile,flip_Angles,mrQ)
%
...
for j=1:numel(FAU)
    ...
    for fa = 1:length(kk)
        ...
        fieldName=['Align' num2str(FAU(j)) 'deg'];
        MultiCoilFile.(fieldName)=SaveFilenameSum;
