function  [X_valdationErr,   gEstT, resnorm, FitT useX, kFold resnormData]=pdX_valdationLoop_1( lambda1,kFold,M0,pBasis,R1basis,g0,mask,options)
...
for ii=1:length(lambda1),
    ...
    for jj=1:kFold
        ...
        [gEstT(:,:,jj,ii), resnorm(ii,jj)] = ...
            lsqnonlin(@(par) errFitNestBiLinearTissueT1reg_full(par,double(M0),...
