function [WFfile1,Gainfile1] =mrQ_WFsmoothPhantom(outDir,CSFfile,pdfile,M0LFfile,BMfile,FSfile,SaveDir)
%
...
mask=BM & PD>0 & (fs>0); %we will fit the smooth data when we have a good data (the white matter ).
