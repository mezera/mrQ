function mrQ = mrQ_initInputData_ver2(mrQ,SPGRf,SEIRf)
% 
%  mrQ = mrQ_initInputData(mrQ,SPGRf,SEIRf)
% 
...
% * iF B1file was defined by the user, the function return only inputdata_spgr 
% 
...
if notDefined('SPGRf');SPGRf=false; end

if notDefined('SEIRf');SEIRf=false; end
...
%% Construct SPGR inputData structure
inputData_spgr = {};
...
% 	- TI must be <=2500 * 
%	- Constant TE
% if there is no B1file, search for SEIR data 
